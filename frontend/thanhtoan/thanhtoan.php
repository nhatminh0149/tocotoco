...
if (isset($_POST['btnDatHang'])) {
    ...
    // Insert Đơn hàng
    // Câu lệnh INSERT
    $sqlDonHang = "INSERT INTO `dondathang` (dh_ngaylap, dh_noigiao, dh_trangthaithanhtoan, httt_ma, kh_tendangnhap) VALUES ('$dh_ngaylap', null, $dh_trangthaithanhtoan, $httt_ma, '$kh_tendangnhap');";
    // dd($sqlDonHang);
    // Thực thi INSERT
    ...
    if (!isset($_SESSION['username'])) {
        header('location:/tocotoco/frontend/pages/login.php');
    } else {
