...
if(isset($_POST['btnDangKy']))
{
   ...
   // $kh_quantri = 0; // Mặc định khi đăng ký sẽ không có quyền quản trị
    ...
    // Câu lệnh INSERT
    $sql = "INSERT INTO khachhang(kh_tendangnhap, kh_matkhau, kh_ten, kh_diachi, kh_dienthoai, kh_email, kh_makichhoat, kh_trangthai) VALUES ('$kh_tendangnhap', '$kh_matkhau', '$kh_ten', '$kh_diachi', '$kh_dienthoai', '$kh_email',  '$kh_makichhoat', $kh_trangthai)";
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('tranlenhatminh97@gmail.com', 'Test Mail');
        ...
        <table>
            <tr>
                <td><h1 style="color: red; font-size: 16px; text-align: center;">TRÀ SỮA TOCOTOCO XIN CHÀO</h1>
            ...
            <tr>
                <td>
                    ...
                    <a href="http://localhost/tocotoco/frontend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
