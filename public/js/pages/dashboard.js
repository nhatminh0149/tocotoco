...
$(document).ready(function() {
    ...
    $.ajax({
        url: '/tocotoco/backend/ajax/baocao-thongkeloaisanpham-ajax.php',
        type: "GET",
    ...
    $.ajax({
        url: '/tocotoco/backend/ajax/baocao-thongketopsanphambanchaynhat-ajax.php',
        type: "GET",
        success: function (response) {
            var data = JSON.parse(response);
            var myLabels = [];
    ...
    $.ajax({
        url: '/tocotoco/backend/ajax/baocao-thongkedoanhthu-ajax.php',
        type: "GET",
        success: function (response) {
            var data = JSON.parse(response);
            var myLabels = [];
