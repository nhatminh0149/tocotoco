...
<body>
    ...
    <form id="suahttt" name="suahttt" method="post" action="">
        Mã HTTT:   <input type="text" id="httt_ma" name="httt_ma" readonly value="<?= $htttRow['httt_ma'] ?>" class="form-control" /><br><br>
        Tên HTTT:   <input type="text" id="httt_ten" name="httt_ten" value="<?= $htttRow['httt_ten'] ?>" class="form-control"/><br><br>
