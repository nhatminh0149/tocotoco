...
<?php
    if(isset($_POST['Luu'])){
        ...
        $sqlInsert = "INSERT INTO khachhang (kh_tendangnhap, kh_matkhau, kh_ten, kh_diachi, kh_dienthoai, kh_email, kh_makichhoat, kh_trangthai) VALUES ('$kh_tendangnhap', '$kh_matkhau', '$kh_ten', '$kh_diachi', '$kh_dienthoai', '$kh_email', '$kh_makichhoat', $kh_trangthai);";
    ...
    try {
        ...
        $siteUrl = 'http://localhost/tocotoco/';
        $body = <<<EOT
        <table>
            <tr>
                <td><h1 style="color: pink; font-size: 16px; text-align: center;">TRÀ SỮA TOCOTOCO XIN CHÀO</h1>
            ...
            <tr>
                <td>
                    ...
                    <a href="http://localhost/tocotoco/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
